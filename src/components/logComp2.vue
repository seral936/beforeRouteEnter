      ...
      <div class="window">
        ...
        <div class="content">
          ...
          <form
            ...
            action="/login"
            method="post"
            v-on:submit.prevent="createAcount"
          >
            <input
              type="email"
              name="email"
            ...
            <input
              ...
              class="input-line full-width"
            />
            <button class="ghost-round full-width" type="submit">Créer mon Compte</button>
          </form>

          <div @click="signIn" class="spacing">Se connecter</div>
        </div>
      </div>
    </div>
  </div>
